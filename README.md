...
This is a .NET 10 WinForms application that demonstrates features of the [CP-IO19R](https://comfiletech.com/raspberry-pi-panel-pc/cp-io19r-i-o-relay-board-for-the-cpi-s-series/) IO board for the [ComfilePi industrial touchscreen panel PCs](https://comfiletech.com/linux-panel-pc/), and how to program it.
...
Both the `ComfileTech.ComfilePi.CP_IO19R.Demo` project and the `ComfileTech.ComfilePi.CP_IO19R` project now target .NET 10.
...
1. Right-click the `ComfileTech.ComfilePi.CP_IO19R.Demo` project and choose **Publish**.
